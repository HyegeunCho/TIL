...
function createWindow() {
    ...
    win.on('closed', () => {
        ...
        // if your app supports multi windows, this is the time
        // when you should delete the corresponding elemet.
        win = null;
    });
}
...
app.on('window-all-closed', () => {
    // On macOS it is common for applications and theiry menu bar
