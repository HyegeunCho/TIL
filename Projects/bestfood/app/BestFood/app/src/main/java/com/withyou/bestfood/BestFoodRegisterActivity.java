...
import com.withyou.bestfood.item.GeoItem;
import com.withyou.bestfood.lib.GoLib;
import com.withyou.bestfood.lib.MyLog;

/**
 * Created by hgcho on 2017. 11. 9..
 * 맛집 등록 액티비티
...
public class BestFoodRegisterActivity extends AppCompatActivity
{
    ...
    /**
     * BestFoodRegisterLocationFragment를 실행하기 위한 기본적인 정보를 설정하고 프래그먼트를 실행한다.
